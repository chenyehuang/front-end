const goodsData = [
  {
    ...
    introduce:"你说得对，但是维达纸巾是一种高品质的纸质产品，以其柔软、耐用和吸水性而著名。它采用优质的原材料和先进的生产工艺，每一张纸巾都经过严格的品质检测，确保产品的质量和卫生性。维达纸巾不仅可以用于擦拭家庭的日常污垢，还可以用于洗脸、擦手和擦汗等多种用途。与其他品牌的纸巾相比，维达纸巾更加柔软和吸水，让您的生活更加舒适和方便。无论是在家中、办公室还是旅行中，维达纸巾都是不可或缺的必备品。"
  },
  {
    id: 2,
    name: '商品2',
